    ...
    <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-2xl shadow-xl">
        ...
        <div class="px-8 py-6 border-b border-gray-200 dark:border-zinc-700">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Bilgilerimi Güncelle</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Profil bilgilerinizi güncelleyin ve fotoğrafınızı değiştirin</p>
                </div>
            </div>
        </div>
        ...
        <form wire:submit.prevent="update" class="p-8 space-y-8">
            ...
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-xl p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Profil Fotoğrafı</h2>
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div class="shrink-0">
                        @if ($photo)
                            <div class="relative">
                                <img class="h-32 w-32 object-cover rounded-full border-4 border-white dark:border-zinc-700 shadow-lg" 
                                     src="{{ $photo->temporaryUrl() }}" alt="Profil fotoğrafı önizleme">
                        ...
                        @elseif($user->photo)
                            <div class="relative">
                                <img class="h-32 w-32 object-cover rounded-full border-4 border-white dark:border-zinc-700 shadow-lg" 
                                     src="{{ Storage::url($user->photo) }}" alt="Mevcut profil fotoğrafı">
                    ...
                    <div class="flex-1 space-y-4">
                        ...
                        <div class="text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <p>• Minimum boyut: 100x100 piksel</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-xl p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Kişisel Bilgiler</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model.defer="name" placeholder="Adınız"
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.defer="surname" placeholder="Soyadınız"
                    ...
                    <div>
                        ...
                        <input type="email" wire:model.defer="email" placeholder="ornek@email.com"
                    ...
                    <div>
                        ...
                        <input type="tel" wire:model.defer="phone" placeholder="+90 555 123 45 67"
            ...
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-xl p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Mesleki Bilgiler</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model.defer="title" placeholder="Örn: Yazılım Geliştirici"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-zinc-700 dark:text-white @error('title') border-red-500 @enderror">
                        @error('title') 
                            <span class="text-red-600 dark:text-red-400 text-sm mt-1 block">{{ $message }}</span> 
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.defer="department" placeholder="Örn: Teknoloji"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-zinc-700 dark:text-white @error('department') border-red-500 @enderror">
                        @error('department') 
                            <span class="text-red-600 dark:text-red-400 text-sm mt-1 block">{{ $message }}</span> 
                        @enderror
                    </div>
            ...
            <!-- Security Section -->
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-xl p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Güvenlik</h2>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Yeni Şifre (İsteğe bağlı)
                    </label>
                    <input type="password" wire:model.defer="password" placeholder="En az 8 karakter"
            ...
            <div class="flex justify-end gap-4 pt-6 border-t border-gray-200 dark:border-zinc-700">
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove>Bilgileri Güncelle</span>
