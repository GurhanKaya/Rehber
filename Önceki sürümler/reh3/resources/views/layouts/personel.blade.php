...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen flex flex-col">
    <nav class="bg-gray-900 shadow-md p-4 text-white" role="navigation" aria-label="Ana navigasyon">
        <div class="container mx-auto flex justify-between items-center">
            <a href="{{ route('personel.home') }}" class="font-bold text-xl hover:text-gray-300 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 rounded" aria-label="Personel Panel ana sayfa">Personel Panel</a>
