<?php
// bu misafir için kullanılan search
...
class UserSearch extends Component
{
    ...
    {
        $this->department = User::select('department')->distinct()->pluck('department')->filter()->toArray();
    ...
    public function render()
    {
        return view('livewire.user-search', [
            'users' => $this->users,
        ])->layout('layouts.guest'); // normal bu viewı döndürüyor
    }
}