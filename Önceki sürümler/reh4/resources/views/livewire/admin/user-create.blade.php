<div class="p-6 max-w-3xl mx-auto bg-white dark:bg-zinc-800 rounded-xl shadow-md space-y-6">
    ...
    <form wire:submit.prevent="save" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <select wire:model.defer="title" class="border rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 dark:bg-zinc-700 dark:text-white @error('title') border-red-500 @enderror">
            ...
            <div>
                <select wire:model.defer="department" class="border rounded-lg p-3 w-full focus:ring-2 focus:ring-blue-500 dark:bg-zinc-700 dark:text-white @error('department') border-red-500 @enderror">
